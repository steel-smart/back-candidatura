...
class WebserviceCaixa {
	...
	function CallNuSOAP($wsdl, $operacao, $conteudo) {
		$client = new \nusoap_client($wsdl, true, $timeout = TIMEOUT);
    ...
    function GetCodigoRetorno()
    {
        ...
        if (isset($this->resposta['DADOS']['CONTROLE_NEGOCIAL']['COD_RETORNO'])){
            return $this->resposta['DADOS']['CONTROLE_NEGOCIAL']['COD_RETORNO'];
        }

        if(isset($this->resposta['COD_RETORNO'])){
            return $this->resposta['COD_RETORNO'];
        }else{
            return null;
        }
    ...
    function GetMensagemRetorno(){
        ...
        if(isset($this->resposta['DADOS']['CONTROLE_NEGOCIAL']['MSG_RETORNO'])){
            return $this->resposta['DADOS']['CONTROLE_NEGOCIAL']['MSG_RETORNO'];
        }else{
            if(isset($this->resposta['MSG_RETORNO'])){
                return $this->resposta['MSG_RETORNO'];
            }else{
                return null;
            }
        }
    ...
    function GetUrlBoleto()
    {
        ...
        if(isset($this->resposta['DADOS']['CONSULTA_BOLETO']['TITULO']['URL'])){
            return $this->resposta['DADOS']['CONSULTA_BOLETO']['TITULO']['URL'];
        }else{
            if(isset($this->resposta['DADOS']['ALTERA_BOLETO']['URL'])){
                return $this->resposta['DADOS']['ALTERA_BOLETO']['URL'];
            }else{
                return null;
            }
        }
    ...
    function GetExcecao(){
        if(isset($this->resposta['DADOS']['EXCECAO'])){

            return $this->resposta['DADOS']['EXCECAO'];
